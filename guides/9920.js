...
//firstboss, not enraged
	...
	//Backstep+donuts, stay in, get out
     ...
     "s-920-1000-1117": [{"type": "text","sub_type": "notification","message": "stay in&#x2191; + get out&#x2193;","message_TW": "&#x7AD9;&#x91CC;&#x9762;&#x2191;+&#x7AD9;&#x5916;&#x9762;&#x2193;"}],
	
	//原地抬腿+内外圈,安全区域:站外面+站里面
	//Stomp+donuts, get out, stay in
	
	 "s-920-1000-1116": [{"type": "text","sub_type": "notification","message": "get out&#x2193; + stay in&#x2191;","message_TW": "&#x7AD9;&#x5916;&#x9762;&#x2193;+&#x7AD9;&#x91CC;&#x9762;&#x2191;"}],
    
	//剑戳地2下+后方挥盾
	//ground thrust 2x+shield swing
	
	 "s-920-1000-1109": [{"type": "text","sub_type": "notification","message": "back attack","message_TW": "&#x540E;&#x65B9;&#x653B;&#x51FB;"}],
	
	//三圈顺序:全+外+内 站里面站外面
	//Massive In-Out Big AoE+Outer AoE+Inner AoE
	
	"s-920-1000-1130": [{"type": "text","sub_type": "notification","message": "full>outer>inner","message_TW": "&#x4F24;&#x5BB3;&#x987A;&#x5E8F;&#xFF1A;&#x5168;>&#x5916;>&#x5185;"}],
...
//firstboss, enraged
	...
	//Backstep+donuts, stay in, get out
     ...
     "s-920-1000-2117": [{"type": "text","sub_type": "notification","message": "stay in&#x2191; + get out&#x2193;","message_TW": "&#x7AD9;&#x91CC;&#x9762;&#x2191;+&#x7AD9;&#x5916;&#x9762;&#x2193;"}],
	
	//原地抬腿+内外圈,安全区域:站外面+站里面
	//Stomp+donuts, get out, stay in
	
	 "s-920-1000-2116": [{"type": "text","sub_type": "notification","message": "get out&#x2193; + stay in&#x2191;","message_TW": "&#x7AD9;&#x5916;&#x9762;&#x2193;+&#x7AD9;&#x91CC;&#x9762;&#x2191;"}],

	//剑戳地2下+后方挥盾
	//ground thrust 2x+shield swing
	
	 "s-920-1000-2109": [{"type": "text","sub_type": "notification","message": "back attack","message_TW": "&#x540E;&#x65B9;&#x653B;&#x51FB;"}],
	 
	//愤怒时 三圈顺序:全+内+外
	//enraged Massive In-Out Big AoE+Inner AoE+Outer AoE
	
     "s-920-1000-2130": [{"type": "text","sub_type": "notification","message": "full>inner>outer","message_TW": "&#x4F24;&#x5BB3;&#x987A;&#x5E8F;&#xFF1A;&#x5168;>&#x5185;>&#x5916;"}],
...
//secondboss, not enraged
	...
	"s-920-2000-1108": [{"type": "text","sub_type": "notification","message": "Target swing","message_TW": "&#x70B9;&#x540D;&#x5212;&#x5200;&#x653B;&#x51FB;"}],
	
	//点名转身划刀,左手边伤害
    //target one player then turn aroud with left swing
	
	"s-920-2000-1113": [{"type": "text","sub_type": "notification","message": "right hand swing","message_TW": "&#x5DE6;&#x624B;&#x4F24;&#x5BB3;"}],
	
	//点名转身划刀,右手边伤害
	//target one player then turn aroud with right swing
	
	"s-920-2000-1114": [{"type": "text","sub_type": "notification","message": "left hand swing","message_TW": "&#x53F3;&#x624B;&#x4F24;&#x5BB3;"}],
    
	//转圈攻击（1106）
	//Spin attack
	
	"s-920-2000-1106": [{"type": "text","sub_type": "notification","message": "Spin attack","message_TW": "&#x8F6C;&#x5708;&#x653B;&#x51FB;"}],
    
	//后方攻击（1105）
	//Back attack
	
    "s-920-2000-1105": [{"type": "text","sub_type": "notification","message": "Back attack","message_TW": "&#x540E;&#x65B9;&#x653B;&#x51FB;"}],
	
	//点名大跳晕人
	//Random aggro stun
	
    "s-920-2000-1104": [{"type": "text","sub_type": "notification","message": "Random jump","message_TW": "&#x70B9;&#x540D;&#x5927;&#x8DF3;"}],

    
	//眩晕攻击
    //Stun attack
   
	"s-920-2000-1110": [{"type": "text","sub_type": "notification","message": "Stun attack","message_TW": "&#x7729;&#x6655;&#x653B;&#x51FB;"}],

	//BOSS右手边划刀,安全区域：坦右,打左
	//right hand side swing, tank goes to right, dps goes to left

	"s-920-2000-1112": [{"type": "text","class_position":"tank","sub_type": "notification","message": "right&#x2192;","message_TW": "&#x53F3;&#x2192;"},
	...
	"s-920-2000-1111": [{"type": "text","class_position":"tank","sub_type": "notification","message": "left&#x2190;","message_TW": "&#x5DE6;&#x2190;"},
...
//secondboss,enraged
	...
	"s-920-2000-2106": [{"type": "text","sub_type": "notification","message": "Spin attack","message_TW": "&#x8F6C;&#x5708;&#x653B;&#x51FB;"}],
 
    //愤怒后方攻击（2105）
	//enraged back attack
	
    "s-920-2000-2105": [{"type": "text","sub_type": "notification","message": "back attack","message_TW": "&#x540E;&#x65B9;&#x653B;&#x51FB;"}], 

	//点名大跳晕人
	//Random aggro stun
	
    "s-920-2000-2104": [{"type": "text","sub_type": "notification","message": "Random jump","message_TW": "&#x70B9;&#x540D;&#x5927;&#x8DF3;"}],

	//BOSS右手边划刀,安全区域：坦右,打左
	//right hand side swing, tank goes to right, dps goes to left

	"s-920-2000-2112": [{"type": "text","class_position":"tank","sub_type": "notification","message": "right&#x2192;","message_TW": "&#x53F3;&#x2192;"},
	                    {"type": "text","class_position":"dps","sub_type": "notification","message": "left&#x2190;","message_TW": "&#x5DE6;&#x2190;"},
	                    {"type": "text","class_position":"heal","sub_type": "notification","message": "left&#x2190;","message_TW": "&#x5DE6;&#x2190;"}],
	...
	"s-920-2000-2111": [{"type": "text","class_position":"tank","sub_type": "notification","message": "left&#x2190;","message_TW": "&#x5DE6;&#x2190;"},
	                    {"type": "text","class_position":"dps","sub_type": "notification","message": "right&#x2192;","message_TW": "&#x53F3;&#x2192;"},
	                    {"type": "text","class_position":"heal","sub_type": "notification","message": "right&#x2192;","message_TW": "&#x53F3;&#x2192;"}],
	...
	"s-920-2000-2110": [{"type": "text","sub_type": "notification","message": "Stun attack","message_TW": "&#x7729;&#x6655;&#x653B;&#x51FB;"}],
	
	//点名转身划刀
	//target one player then turn aroud with swing
	
	"s-920-2000-2108": [{"type": "text","sub_type": "notification","message": "Target swing","message_TW": "&#x70B9;&#x540D;&#x5212;&#x5200;&#x653B;&#x51FB;"}],
	
	//点名转身划刀,左手边伤害
    //target one player then turn aroud with left swing
	
	"s-920-2000-2113": [{"type": "text","sub_type": "notification","message": "right hand swing","message_TW": "&#x5DE6;&#x624B;&#x4F24;&#x5BB3;"}],
	
	//点名转身划刀,右手边伤害
	//target one player then turn aroud with right swing
	
	"s-920-2000-2114": [{"type": "text","sub_type": "notification","message": "left hand swing","message_TW": "&#x53F3;&#x624B;&#x4F24;&#x5BB3;"}],
...
//secondboss, special attacks
	...
	"s-920-2000-3119": [{"type": "text","sub_type": "notification","message": "red: get out&#x2193;","message_TW": "&#x7EA2;&#x8272;&#xFF1A;&#x5916;&#x2193;"}],
	
    //蓝色鉴定,安全区域：15M内（3220）
	//Blue, stay near within 15m
	
	"s-920-2000-3220": [{"type": "text","sub_type": "notification","message": "blue: stay in&#x2191;","message_TW": "&#x84DD;&#x8272;&#xFF1A;&#x5185;&#x2191;"}],
	
    //眩晕圈（3116）+外圈伤害（3118）
	//stun+donut
	
    "s-920-2000-3116": [{"type": "text","sub_type": "notification","message": "dodge + stay in&#x2191;","message_TW": "&#x8EB2;&#x907F;+&#x5185;&#x2191;"}],
...
//thirdboss, unenraged
	...
	//pushback when engaging
     ...
     "s-920-3000-1315": [{"type": "text","sub_type": "notification","message": "Pushback","message_TW": "&#x5F00;&#x573A;&#x63A8;&#x4EBA;"}],
	 
	//点名大跳晕人（1107）
	//random aggro stun
	
    "s-920-3000-1107": [{"type": "text","sub_type": "notification","message": "Random jump","message_TW": "&#x70B9;&#x540D;&#x5927;&#x8DF3;"}],
	
	//点名出剑刃风暴（1204）
	//random target energy beam
    "s-920-3000-1204": [{"type": "text","sub_type": "notification","message": "energy beam","message": "&#x70B9;&#x540D;&#x5251;&#x6C14;"}],
   ...
   //front, back slam
	...
	"s-920-3000-1113": [{"type": "text","sub_type": "notification","message": "front, back slam","message_TW": "&#x524D;&#x540E;&#x7838;"}],
	
    //旋转攻击
	//spinning attack
	
	"s-920-3000-1115": [{"type": "text","sub_type": "notification","message": "spinning attack","message_TW": "&#x65CB;&#x8F6C;&#x653B;&#x51FB;"}],
    
	//2连斜上挥（1104）后接的后砸（1119）
	//golf swing x2 + back slam
	
	"s-920-3000-1104": [{"type": "func","func": back_attack_HM}],
	
	//后闪+旋转or前后砸
	//teleport back+ spin or front, back slam
	
	"s-920-3000-1202": [{"type": "text","sub_type": "notification","message": "spin or front,back slam","message_TW": "&#x65CB;&#x8F6C;or&#x524D;&#x540E;&#x7838;"}],
	
	//蓝球+镭射
	//target energy beam（almost tank ?_?）

	"s-920-3000-1120": [{"type": "text","sub_type": "notification","message": "energy beam","message_TW": "&#x5251;&#x6C14;&#x653B;&#x51FB;"}],
...
//thirdboss, enraged
    ...
    "s-920-3000-2204": [{"type": "text","sub_type": "notification","message": "enraged:energy beam","message_TW": "&#x6124;&#x6012;&#xFF1A;&#x70B9;&#x540D;&#x5251;&#x6C14;"}],
   ...
   //front, back slam
	...
	"s-920-3000-2113": [{"type": "text","sub_type": "notification","message": "front, back slam","message_TW": "&#x524D;&#x540E;&#x7838;"}],

	//2连斜上挥（1104）后接的后砸（1119）
	//golf swing x2 + back slam
	
	"s-920-3000-2104": [{"type": "func","func": back_attack_HM}],
	
    //旋转攻击
	//spinning attack
	
	"s-920-3000-2115": [{"type": "text","sub_type": "notification","message": "spinning attack","message_TW": "&#x65CB;&#x8F6C;&#x653B;&#x51FB;"}],
	
	//点名大跳晕人（1107）
	//random aggro stun
	
    "s-920-3000-2107": [{"type": "text","sub_type": "notification","message": "Random jump","message_TW": "&#x70B9;&#x540D;&#x5927;&#x8DF3;"}],
	
    //后闪+旋转or前后砸
	//teleport back+ spin or front, back slam
	
	"s-920-3000-2202": [{"type": "text","sub_type": "notification","message": "spin or front,back slam","message_TW": "&#x65CB;&#x8F6C;or&#x524D;&#x540E;&#x7838;"}],
	
	//蓝球+镭射
	//target energy beam（almost tank ?_?）

	"s-920-3000-2120": [{"type": "text","sub_type": "notification","message": "energy beam","message_TW": "&#x5251;&#x6C14;&#x653B;&#x51FB;"}],
...
//thirdboss, special attacks
	...
	"s-920-3000-1400": [{"type": "text","sub_type": "notification","message": "beam","message_TW": "&#x53EC;&#x5524;&#x5206;&#x8EAB;&#xFF1A;&#x70B9;&#x540D;&#x5251;&#x6C14;"}],
	
	//召唤分身出旋转攻击
	//clones, random aggro, spin attack
	
    "s-920-3000-1401": [{"type": "text","sub_type": "notification","message": "spin","message_TW": "&#x53EC;&#x5524;&#x5206;&#x8EAB;&#xFF1A;&#x65CB;&#x8F6C;&#x653B;&#x51FB;"}],
